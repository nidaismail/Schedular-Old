                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="locationContainer">
                                                <select name="location" id="locationSelect" class="form-control @error('location') is-invalid @enderror">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const originalSelect = locationContainer.innerHTML;

    activitySelect.addEventListener('change', function () {
        const selectedActivity = parseInt(this.value);
        
        if (selectedActivity === 2 || selectedActivity === 4) {
            const dropdown = `
                <div class="form-group">
                    ...
                    <div class="dropdown-menu p-3" aria-labelledby="locationDropdown" style="max-height: 200px; overflow-y: auto; width: 300px;">
                        @foreach($locations as $loc)
                            <div class="form-check">
                                <input type="checkbox" name="location[]" id="location_{{ $loc->id }}" value="{{ $loc->id }}" class="form-check-input" {{ in_array($loc->id, old('location', [])) ? 'checked' : '' }}>
            ...
            `;
            locationContainer.innerHTML = dropdown;
        } else {
            locationContainer.innerHTML = originalSelect;
        }
    });
});
